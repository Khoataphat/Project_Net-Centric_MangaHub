...
const (
	MangaService_GetMangaDetail_FullMethodName = "/manga.MangaService/GetMangaDetail"
)
...
//
// Định nghĩa dịch vụ Manga
type MangaServiceClient interface {
	// API lấy thông tin chi tiết Manga theo ID
	GetMangaDetail(ctx context.Context, in *MangaRequest, opts ...grpc.CallOption) (*MangaResponse, error)
}
...
func (c *mangaServiceClient) GetMangaDetail(ctx context.Context, in *MangaRequest, opts ...grpc.CallOption) (*MangaResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MangaResponse)
	err := c.cc.Invoke(ctx, MangaService_GetMangaDetail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MangaServiceServer interface {
	// API lấy thông tin chi tiết Manga theo ID
	GetMangaDetail(context.Context, *MangaRequest) (*MangaResponse, error)
...
func (UnimplementedMangaServiceServer) GetMangaDetail(context.Context, *MangaRequest) (*MangaResponse, error) {
...
func _MangaService_GetMangaDetail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MangaRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MangaServiceServer).GetMangaDetail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MangaService_GetMangaDetail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MangaServiceServer).GetMangaDetail(ctx, req.(*MangaRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _MangaService_GetMangaDetail_Handler,
		},
	},
